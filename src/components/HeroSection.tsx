...
export default function HeroSection({ visible, theme, style }: HeroSectionProps) {
  ...
  return (
    <section id="home" className={`hero-section hero-section--${theme}`} style={style}>
      <InteractiveDots
      ...
      <div className="hero-section__bottom-overlay" />
      <div className={`hero-section__inner ${visible ? 'hero-section__inner--visible' : ''}`}>
        <div className="hero-section__content">
          <div className="hero-section__left">
            <h1 className="hero-section__name">{siteConfig.name}</h1>

            <TextAnimate texts={siteConfig.roles} as="h2" className="hero-section__role" />
